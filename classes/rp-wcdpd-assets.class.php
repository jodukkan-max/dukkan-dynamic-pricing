 ...
 */
    ...
    public function enqueue_frontend_assets()
    {
        ...
        if (is_cart() || is_checkout()) {
            wp_enqueue_script('rp-wcdpd-blocks-interop', RP_WCDPD_PLUGIN_URL . '/assets/js/cart-checkout-block-interop.js', array('wc-blocks-checkout', 'wc-blocks-data-store', 'wp-data', 'wc-settings'), RP_WCDPD_VERSION, true);
        }
