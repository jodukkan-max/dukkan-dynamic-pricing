...
<div id="rp_wcdpd_preloader">
    <div id="rp_wcdpd_preloader_content">
        ...
        <p class="rp_wcdpd_preloader_text">
            <?php printf(esc_html__('This plugin uses a JavaScript-driven user interface. If this notice does not disappear in a few seconds, you should check Console for any JavaScript errors or get in touch with %s.', 'rp_wcdpd'), '<a href="https://url.rightpress.net/7119279-support">' . esc_html__('RightPress Support', 'rp_wcdpd') . '</a>'); ?><br>
        </p>
