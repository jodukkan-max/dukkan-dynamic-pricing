...
class RP_WCDPD_Promotion_Countdown_Timer
{
    ...
    public static function get_countdown_timer_data($product, $quantity = 1, $variation_attributes = array())
    {
        ...
        // Get label
        $label = apply_filters('rp_wcdpd_promotion_countdown_timer_label', wp_kses_post(RP_WCDPD_Settings::get('promo_countdown_timer_label')), $product, $seconds_remaining, $quantity);
        ...
        return apply_filters('rp_wcdpd_promotion_countdown_timer_data', array(
            ...
            'days'              => str_pad((int) ($seconds_remaining / (60 * 60 * 24)), 2, '0', STR_PAD_LEFT),
            'hours'             => str_pad((int) ($seconds_remaining / (60 * 60)) % 24, 2, '0', STR_PAD_LEFT),
            'minutes'           => str_pad((int) ($seconds_remaining / 60) % 60, 2, '0', STR_PAD_LEFT),
            'seconds'           => str_pad((int) $seconds_remaining % 60, 2, '0', STR_PAD_LEFT),
        ), $product);
    }
