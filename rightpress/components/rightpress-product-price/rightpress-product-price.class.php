...
final class RightPress_Product_Price
{
    ...
    // Track products that are in cart
    ...
    private function __construct()
    {
        ...
        // Track products that are in cart
        $this->products_in_cart = new SplObjectStorage();
    ...
    public function flag_product_in_cart($cart_item_data)
    {
        ...
        // Set product in cart
        RightPress_Product_Price::set_product_in_cart($cart_item_data['data'], $cart_item_data['key']);
     ...
     * @return void
     */
    public static function set_product_in_cart($product, $cart_item_key)
    {

        // Make sure product is object
        ...
        // Set product in cart
        $instance->products_in_cart[$product] = $cart_item_key;
    }
     ...
     * @return string|bool
     */
    public static function get_product_in_cart($product)
    {
        ...
        // Product is set
        if ($instance->products_in_cart->offsetExists($product)) {

            // Return cart item key
            return $instance->products_in_cart[$product];
        }
    ...
    /**
     * Unset product in cart
     *
     * @access public
     * @param object $product
     * @return void
     */
    public static function unset_product_in_cart($product)
    {
        ...
        if ($instance->products_in_cart->offsetExists($product)) {
            ...
            // Unset product
            $instance->products_in_cart->offsetUnset($product);
        }
    }
