...
final class RightPress_Product_Price_Breakdown
{
    ...
    public static function generate_prices_array($base_price, $total_quantity, $product = null)
    {
        ...
        return array(
            ...
            ('to_' . $total_quantity) => array(
                ...
                'regular_price' => null,            // Marked-up regular price, set by percentage fee markup methods
     ...
     * @return void
     */
    public static function set_price_to_prices_array(&$prices, $pointer_key, $price, $price_range_index, $quantity, $changes = array(), $skip_non_adjusted_quantity = false, $regular_price = null)
    {
        ...
        // Optionally set the marked-up regular price (percentage fee markup methods)
        if ($regular_price !== null) {
            $price_range['regular_price'] = $regular_price;
        }
    ...
    public static function get_price_breakdown_for_display($price_data)
    {
        ...
        foreach ($price_data['prices']['ranges'] as $price_range) {
            ...
            // Get full price
            $full_price = (isset($price_range['regular_price']) && $price_range['regular_price'] !== null) ? $price_range['regular_price'] : RightPress_Product_Price_Changes::get_highest_price_from_cart_item_price_changes($price_data, $price_range);
