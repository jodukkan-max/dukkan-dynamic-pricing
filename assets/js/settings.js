...
jQuery(document).ready(function() {
     ...
     */
    jQuery(['rp_wcdpd_promo_your_price', 'rp_wcdpd_promo_total_saved', 'rp_wcdpd_promo_countdown_timer', 'rp_wcdpd_promo_volume_pricing_table', 'rp_wcdpd_promo_product_banners', 'rp_wcdpd_promo_cart_item_descriptions']).each(function(index, value) {
