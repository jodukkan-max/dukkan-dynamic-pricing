...
class RP_WCDPD
{
    ...
    public static function php_version_notice()
    {
        ...
        echo '<div class="error"><p>' . sprintf(esc_html__('%1$s requires PHP %2$s or later. Please update PHP on your server to use this plugin.', 'rp_wcdpd'), '<strong>WooCommerce Dynamic Pricing & Discounts</strong>', RP_WCDPD_SUPPORT_PHP) . ' ' . sprintf(esc_html__('If you have any questions, please contact %s.', 'rp_wcdpd'), ('<a href="https://url.rightpress.net/new-support-ticket">' . esc_html__('RightPress Support', 'rp_wcdpd') . '</a>')) . '</p></div>';
    }
    ...
    public static function wp_version_notice()
    {
        ...
        echo '<div class="error"><p>' . sprintf(esc_html__('%1$s requires WordPress version %2$s or later. Please update WordPress to use this plugin.', 'rp_wcdpd'), '<strong>WooCommerce Dynamic Pricing & Discounts</strong>', RP_WCDPD_SUPPORT_WP) . ' ' . sprintf(esc_html__('If you have any questions, please contact %s.', 'rp_wcdpd'), ('<a href="https://url.rightpress.net/new-support-ticket">' . esc_html__('RightPress Support', 'rp_wcdpd') . '</a>')) . '</p></div>';
    }
    ...
    public static function wc_disabled_notice()
    {
        ...
        echo '<div class="error"><p>' . sprintf(esc_html__('%1$s requires WooCommerce to be active. You can download WooCommerce %2$s.', 'rp_wcdpd'), '<strong>WooCommerce Dynamic Pricing & Discounts</strong>', ('<a href="https://url.rightpress.net/woocommerce-download-page">' . esc_html__('here', 'rp_wcdpd') . '</a>')) . ' ' . sprintf(esc_html__('If you have any questions, please contact %s.', 'rp_wcdpd'), ('<a href="https://url.rightpress.net/new-support-ticket">' . esc_html__('RightPress Support', 'rp_wcdpd') . '</a>')) . '</p></div>';
    }
    ...
    public function plugins_page_links($links)
    {
        ...
        // Support
        $settings_link = '<a href="https://url.rightpress.net/7119279-support">' . esc_html__('Support', 'rp_wcdpd') . '</a>';
